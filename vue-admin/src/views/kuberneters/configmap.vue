          ...
          <el-table-column label="yaml" width="100px">
            <template slot-scope="scope">
              <el-popover placement="bottom" width="70%" trigger="click">
                <div style="height: 100vh; padding: 20px; overflow: scroll">
...
import { configmaps } from "@/api/k8s/configmap";
...
export default {
  ...
  methods: {
    ...
    fetchconfigmap(namespace) {
      this.activeNamespace = namespace;
      configmaps(this.activeCluster, this.activeNamespace).then((response) => {
